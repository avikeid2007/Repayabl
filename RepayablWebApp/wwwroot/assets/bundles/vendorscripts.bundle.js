                ...
                return this.each(function () {
                    ...
                    if (f.parent().hasClass(_.wrapperClass)) {
                        ...
                        if (i(), w.isPlainObject(x)) {
                            ...
                            } else "height" in x && (b = x.height, f.parent().css("height", b), f.css("height", b)); if ("scrollTo" in x) v = parseInt(_.scrollTo);
...
var pJS = function (t, e) {
    ...
    e && Object.deepExtend(d, e), d.tmp.obj = {
        ...
        } else this.shape = n; if ("image" == this.shape) {
        ...
        else e = t.radius; if (null != t.opacity_bubble) var i = t.opacity_bubble;
        else i = t.opacity; if (t.color.rgb) var s = "rgba(" + t.color.rgb.r + "," + t.color.rgb.g + "," + t.color.rgb.b + "," + i + ")";
