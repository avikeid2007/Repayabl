...
namespace Repayabl.Controllers
{
    ...
    public class PropertyController : CoreController
    {
        ...
        [HttpGet]
        public ActionResult<IEnumerable<Models.DTOs.Property>> GetProperties(Guid? UserId, int? skip = null, int? top = null)
        {
        ...
        public ActionResult<IEnumerable<Models.DTOs.Room>> GetRooms(Guid propertyid, int? skip = null, int? top = null)
        {
        ...
        public async Task<ActionResult> SaveRoomAsync(Guid propertyid, Models.DTOs.Room room)
        {
