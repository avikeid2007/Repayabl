...
namespace Repayabl.Controllers
{
    ...
    public class TenantController : CoreController
    {
        ...
        public ActionResult<IEnumerable<Models.DTOs.FamilyDetail>> GetFamilyDetails(Guid tenantid, int? skip = null, int? top = null)
        {
        ...
        public async Task<ActionResult> SaveFamilyDetailAsync(Guid tenantid, Models.DTOs.FamilyDetail FamilyDetail)
        {
        ...
        public async Task<ActionResult> UpdateFamilyAsync(Guid tenantid, Guid id, Models.DTOs.Property property)
        {
        ...
        public async Task<ActionResult<Models.DTOs.FamilyDetail>> GetTenantAsync(Guid tenantid, Guid id)
        {
        ...
        public ActionResult<IEnumerable<Models.DTOs.TenantDocument>> GetTenantDocuments(Guid tenantid, int? skip = null, int? top = null)
        {
        ...
        public async Task<ActionResult> SaveTenantDocumentAsync(Guid tenantid, Models.DTOs.TenantDocument TenantDocument)
        {
        ...
        public async Task<ActionResult> UpdateTenantDocumentAsync(Guid tenantid, Guid id, Models.DTOs.Property property)
        {
        ...
        public async Task<ActionResult<Models.DTOs.TenantDocument>> GetTenantDocumentAsync(Guid tenantid, Guid id)
        {
        ...
        public ActionResult<IEnumerable<Models.DTOs.TenantOutstanding>> GetTenantOutstandings(Guid tenantid, int? skip = null, int? top = null)
        {
        ...
        public async Task<ActionResult> SaveTenantOutstandingAsync(Guid tenantid, Models.DTOs.TenantOutstanding TenantOutstanding)
        {
        ...
        public async Task<ActionResult> UpdateTenantOutstandingAsync(Guid tenantid, Guid id, Models.DTOs.Property property)
        {
        ...
        public async Task<ActionResult<Models.DTOs.TenantOutstanding>> GetTenantOutstandingAsync(Guid tenantid, Guid id)
        {
